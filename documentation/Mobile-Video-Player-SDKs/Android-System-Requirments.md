...
* Android SDK and Android SDK Tools (install these from within Android Studio - see this [article](/api-docs/05_Mobile-Video-Player-SDKs/Android-Getting-Started.html) for details).
